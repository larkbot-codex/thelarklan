...
<!-- State the independently useful behavior and why it is needed. -->
...
<!-- For each exception: rule, justification, compensating control, owner, review date. -->

None.

## Author checklist

- [ ] The pull request contains one independently useful change.
- [ ] Behavior, documentation, tests, and CI contracts are aligned.
